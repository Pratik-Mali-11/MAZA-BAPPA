                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr id="<?php echo $data[$i]->id; ?>">
                        ...
                        <td><?= $data[$i]->title ?></td>
                        <td>
                  <a href="https://nmcfest.nmc.gov.in/"><?= $data[$i]->link ?></a>
                        </td>
                        <td>
                          <a
                            class="btn btn-info"
                            href="<?= base_url('Dashboard/edit_single_announcement/').$data[$i]->id ?>"
                            >Edit</a
                          >
                        </td>
                       
                      <td><a class="btn text-white btn-danger remove" type="submit">Delete</a></td>
                      </tr>
