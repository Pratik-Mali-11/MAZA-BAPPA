        ...
        <div class="page-container">
          ...
          <div class="main-content">
            <div class="page-header no-gutters has-tab">
              <h2 class="font-weight-normal">Edit Popup's</h2>
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-ammonium"
                    >2. Ammonium Bicarbonate Popup</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-slot"
                    >3. Book your Slot Popup</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab-mandal"
                    >4. Ganesh Mandal's Popup</a
                  >
                </li>
                <li class="nav-item">
                        ...
                        <form>
                          ...
                          <div class="form-group">
                            <div class="checkbox">
                              ...
                              <label for="gridCheck">Disable Popup</label>
                            </div>
                          </div>
