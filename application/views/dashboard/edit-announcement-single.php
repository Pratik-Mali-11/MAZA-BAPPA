            ...
            <div class="card">
              <div class="card-body responsive">
                <div class="d-flex justify-content-between align-items-center">
                  <h3 class="mb-0">Edit Announcements</h3>
                </div>
                <hr class="m-v-25" />
              <form action="<?php echo base_url('DbCon/edit_announcements/' . $data[0]->id);?>" method="post" novalidate="">
                  <div class="form-row">
                    <div class="form-group col-md-10">
                      <label class="font-weight-semibold" for="announcement"
                  ...
                  <!-- <div class="form-group">
                    <div class="checkbox">
                      ...
                      <label for="gridCheck"
                        >If links refer to another site pls check this.</label
                      >
                    </div>
                  </div> -->
