        ...
        <div class="page-container">
          ...
          <div class="main-content">
            <div class="page-header no-gutters">
              <h2 class="font-weight-normal">Add Offline Ganesh Visarjan Data</h2>
            </div>
            <div class="container">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form>
                          ...
                          <div class="form-group col-md-12">
                            <label class="font-weight-semibold" for="inputState"
                                >Select Visarjan Pond :</label
                              >
                            <select id="inputState" class="form-control">
                            <option
                          value="Your Technical Area of Interest"
                          selected
                          disabled
                        >
                        ...
                        <option value="6">Six</option>
                            ...
                            <div class="form-group col-md-12">
                              <label class="font-weight-semibold" for="title"
                                >Total Visarjan Count :</label
                              >
                              <input
                                type="number"
                                class="form-control"
                                id="count"
                                placeholder="Enter Total Visarjan Count"
                              />
                            </div>
                          </div>
