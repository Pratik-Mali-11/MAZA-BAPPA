...
<html class="no-js" lang="en">
  <head>
    <title>Ganesh Festival System &mdash; Get Ammonium Bicarbonate</title>
    <meta charset="utf-8" />
              ...
              <div class="text-center mt-4">
                ...
                >
                  <ul class="font-weight-600">
                    ...
                    <li class="text-extra-light-gray">Get Ammonium Bicarbonate</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          >
            <div class="row justify-content-center">
              ...
              <?php $k = "get_ammonium";?>
                ...
                <!-- start ammonium form -->
                <form action="<?php echo base_url('DbCon/add_ammonium/' . $k);?>" method="post" novalidate="">
                  <div class="row row-cols-1 row-cols-md-2">
                    ...
                    Select type of Murti
                      ...
                      <option value="Plaster Of Paris">POP Murti</option>  
                    </select>
                    </div>
                  ...
                  <label class="margin-15px-bottom font-weight-600">You are booking for
                      <span class="required-error text-radical-red">*</span
                    ></label> 
                    <select
                      class="
                    ...
                    Select type of booking
                      ...
                      <option value="Gharguti(Residential)">Gharguti(Residential)</option>
                      <option value="Sarvjanik(Socity/Mandal)">Sarvjanik(Socity/Mandal)</option>  
                    </select>
                      ...
                      >
                        <option value="none" selected>
                      Weight of Murti in KG
                        </option>
                        <option value="1 to 3 Kg">1 to 3 Kg </option>
                        <option value="3 to 5 Kg">3 to 5 Kg </option>
                        <option value="5 to 7 Kg">5 to 7 Kg </option>
                        <option value="7 to 10 Kg">7 to 10 Kg </option>
                        <option value="More than 10 Kg">More than 10 Kg </option>
