                                            ...
                                            <table class="table text-center">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?= $_SESSION['status']['name'] ?></td>
                                                        <td><?= $_SESSION['status']['murti_type'] ?></td>
                                                        <td><?= $_SESSION['status']['booking_type'] ?></td>
                                                        <td><?= $_SESSION['status']['murti_weight'] ?></td>
                                                        <td><?= $_SESSION['status']['division_name'].'-'.$_SESSION['status']['center_name'] ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="row m-t-10 lh-2">
                                            <div class="col-sm-12">
                                                <div class="border-bottom p-v-20">
                                                    ...
                                                    <p class="text-opacity">&nbsp;&nbsp;&nbsp;2. DO NOT FORGET to Download/Print your Ammonium Powder Booking E-Receipt.</p>
                                                </div>
                                            </div>
                                        </div>
