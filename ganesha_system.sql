...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2021 at 05:02 PM
...
CREATE TABLE `get_ammonium` (
  ...
  `registered_at` varchar(50) NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, '308300121', 'Unicorn Design World', 'Association', 2147483647, 'gborse108@gmail.com', '2021-08-02', 'NH7633356', 'Malegoan', 'Amit Patel', '083001-my-invoice-(1).pdf', 22, '2021-08-08 20:30:01', 0);
...
CREATE TABLE `slot_booking` (
  ...
  `booked_at` varchar(50) NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
